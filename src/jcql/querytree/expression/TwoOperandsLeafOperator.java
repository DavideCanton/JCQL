...
public abstract class TwoOperandsLeafOperator extends LeafOperator
{
    public TwoOperandsLeafOperator(String string)
    {
        super(string);
    }
    ...
    public boolean equals(Object o)
    {
        ...
        return left.equals(or.getLeft()) && right.equals(or.getRight()) ||
                left.equals(or.getRight()) && right.equals(or.getLeft());
    }
