...
public abstract class Operator extends QueryNode
{
	 ...
	 * 
	 * @param left
	 *            L'espressione da legare come figlio sinistro.
	 */
	 ...
	 * 
	 * @param right
	 *            L'espressione da legare come figlio destro.
	 */
	...
	public boolean isBound()
	{
		...
		return left.isBound() && (right != null ? right.isBound() : true);
	}
	 ...
	 * 
	 * @param old
	 *            Il figlio da rimpiazzare.
	 * @param new_son
	 *            Il figlio con cui sostituire.
	 */
