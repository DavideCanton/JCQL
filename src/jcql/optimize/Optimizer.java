...
import jcql.querytree.logic.AndOperator;
import jcql.querytree.logic.OrOperator;
...
public class Optimizer
{
     ...
     *
     * @param query La query da ottimizzare.
    ...
    public static QueryNode optimize(QueryNode query)
    {
        ...
        if (query.getRight() == null)
        {
			 ...
			 */
            if (query.getLeft() != null && query.getLeft().isBound())
            {
